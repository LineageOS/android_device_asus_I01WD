...
const std::map<int32_t, TouchscreenGesture::GestureInfo> TouchscreenGesture::kGestureInfoMap = {
    {0, {46, "Letter C"}}, {1, {18, "Letter e"}}, {2, {32, "Letter S"}},
    {3, {47, "Letter V"}}, {4, {17, "Letter W"}}, {5, {44, "Letter Z"}},
};

const int kKeyMaskGestureControl = 0x40;
...
Return<bool> TouchscreenGesture::setGestureEnabled(
    ...
    auto gestureModeString = encode_binary(gestureMode);

    file << gestureModeString;
